...
public class LauncherConstants {
    public static enum LauncherState {
        OFF(0), MANUAL(50), SCORING(50), PASSING(75); // TODO: find proper hood angles
    ...
    public static final double LAUNCHER_HEIGHT_METERS = Units.inchesToMeters(22.5); // TODO: double check
