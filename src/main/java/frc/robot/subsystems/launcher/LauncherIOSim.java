...
public class LauncherIOSim implements LauncherIO {
    private SingleJointedArmSim launcherPhysicsSim = new SingleJointedArmSim(
        DCMotor.getKrakenX60(1),
        LauncherConstants.LAUNCHER_GEARING,
        SingleJointedArmSim.estimateMOI(LauncherConstants.ROLLER_RADIUS_METERS, LauncherConstants.ROLLER_MASS_KG),
    ...
    public void updateSim() {
        ...
        launcherSimState.setRawRotorPosition(Units.radiansToRotations(launcherPhysicsSim.getAngleRads()));
        launcherSimState.setRotorVelocity(Units.radiansPerSecondToRotationsPerMinute(launcherPhysicsSim.getVelocityRadPerSec()) / 60);
