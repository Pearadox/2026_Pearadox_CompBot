...
public class ClimberConstants {
    ...
    public static final double CLIMBER_DRUM_RADIUS_METERS = 0.25;
    ...
    public static final double CLIMBER_DRUM_CIRCUMFERENCE = Units.inchesToMeters(2*CLIMBER_DRUM_RADIUS_METERS*Math.PI);
