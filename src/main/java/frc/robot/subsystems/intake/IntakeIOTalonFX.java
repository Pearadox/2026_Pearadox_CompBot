...
public abstract class IntakeIOTalonFX implements IntakeIO {
    ...
    protected IntakeIOTalonFX() {
        ...
        roller1Leader = new PearadoxTalonFX(IntakeConstants.ROLLER_1_LEADER_ID, IntakeConstants.getRollerConfigTalonFX());
        roller2Follower = new PearadoxTalonFX(IntakeConstants.ROLLER_2_FOLLOWER_ID, IntakeConstants.getRollerConfigTalonFX());
    ...
    public void runRollersVolts (double volts) {
        roller1Leader.setControl(new VoltageOut(volts));
        roller2Follower.setControl(new Follower(IntakeConstants.ROLLER_1_LEADER_ID, MotorAlignmentValue.Opposed));
    }
