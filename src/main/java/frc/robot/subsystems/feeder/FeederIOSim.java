...
public class FeederIOSim implements FeederIO {
    ...
    private DCMotorSim physicsSim = new DCMotorSim(
        LinearSystemId.createDCMotorSystem(
            FeederConstants.FEEDER_MOTOR,
            0.001,
            FeederConstants.FEEDER_GEARING),
        FeederConstants.FEEDER_MOTOR);
    ...
    public void updateSim() {
        ...
        feederSim.setRawRotorPosition(physicsSim.getAngularPositionRotations() * FeederConstants.FEEDER_GEARING);
