...
public final class Constants {
  ...
  public static final class VisualizerConstants {
    public static final Translation3d MODEL0_ZERO = new Translation3d(-0.146050, -0.133350, 0);
    public static final Translation3d MODEL1_ZERO = new Translation3d(0, -0.029545, 0.446088);
    public static final Translation3d MODEL2_ZERO = new Translation3d(0.279344, 0, 0.213924);
    ...
    public static final double HOOD_STARTING_ANGLE = Units.degreesToRadians(61.549451); // TODO: update
    ...
    public static final double HOPPER_EXTENSION = 0.3019; // m from starting position (<12 in)
  }
