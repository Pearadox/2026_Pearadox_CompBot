...
public class RobotVisualizer {
  ...
  public void periodic() {
    ...
    Transform3d turret =
        new Transform3d(Z0_ZERO, new Rotation3d(0, 0, -turretYaw + TURRET_STARTING_ANGLE));
    hoodTransform =
        turret.plus(
            new Transform3d(Z1_OFFSET, new Rotation3d(-hoodPitch + HOOD_STARTING_ANGLE, 0, 0)));
    Transform3d spindexer = new Transform3d(Z2_ZERO, new Rotation3d(0, 0, -spindexerYaw));
    Transform3d intake =
        new Transform3d(Z3_ZERO, new Rotation3d(0, -intakeRoll + INTAKE_STARTING_ANGLE, 0));
    Transform3d intakeGravityRamp =
        intake.plus(
            new Transform3d(Z4_OFFSET, new Rotation3d(0, getGravityRampAngle(intakeRoll), 0)));
    Transform3d climber =
        new Transform3d(
            new Translation3d(0, 0, climberDisplacement - CLIMBER_MAX_DISPLACEMENT),
            Rotation3d.kZero);
